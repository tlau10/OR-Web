<template>
  <v-app id="inspire">
    ...
    <v-navigation-drawer v-model="drawer" app>
      <v-list-item>
        <v-list-item-content>
          <v-list-item-title class="title"> OR-Web </v-list-item-title>
          <v-list-item-subtitle> SS2021 </v-list-item-subtitle>
        </v-list-item-content>
      </v-list-item>
...
export default {
  data: () => ({
    ...
    items: [
      ...
      { title: "Methodenübersicht_v2", icon: "mdi-function-variant", to: "/methodenuebersicht_v2"},
